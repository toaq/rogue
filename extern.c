...
struct h_list helpstr[] = {
    ...
    {'J',	"	bûaıfa namı",				FALSE},
    {'K',	"	bûaıfa bero",				FALSE},
    {'L',	"	bûaıfa hochu",				FALSE},
    {'Y',	"	bûaıfa berohore",				FALSE},
    {'U',	"	bûaıfa berohochu",			FALSE},
    {'B',	"	bûaıfa namıhore",			FALSE},
    {'N',	"	bûaıfa namıhochu",			FALSE},
    {CTRL('H'),	"	bûaıfa hore chòe lêaq",		FALSE},
    {CTRL('J'),	"	bûaıfa namı chòe lêaq",		FALSE},
    {CTRL('K'),	"	bûaıfa bero chòe lêaq",			FALSE},
    {CTRL('L'),	"	bûaıfa right chòe lêaq",		FALSE},
    {CTRL('Y'),	"	bûaıfa berohore chòe lêaq",		FALSE},
    {CTRL('U'),	"	bûaıfa beroright chòe lêaq",		FALSE},
    {CTRL('B'),	"	bûaıfa namıhore chòe lêaq",	FALSE},
    {CTRL('N'),	"	bûaıfa namıhochu chòe lêaq",	FALSE},
    {'\0',	"	<SHIFT><feo>: bûaıfa",		TRUE},
    {'\0',	"	<CTRL><feo>: bûaıfa chòe lêaq",	TRUE},
