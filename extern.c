...
struct h_list helpstr[] = {
    ...
    {'f',	"<feo>	sôı chòe mûaqsho ra juı",	TRUE},
    {'t',	"<feo>	hîeq ja sa",			TRUE},
    {'m',	"<feo>	kôı ja cìy hêaqsho ja sa",		TRUE},
    {'z',	"<feo>	chôq majıbeaq",		TRUE},
    {'^',	"<feo>	kâqgaı ja baq cheychuo",			TRUE},
    {'s',	"	jôaı ja baq cheychuo ra kıao",		TRUE},
    {'>',	"	gûqfa ja chõu pueqmy",			TRUE},
    {'<',	"	gêafa ja chõu pueqmy",			TRUE},
    {'.',	"	tôaıtao sea ja",			TRUE},
    {',',	"	hêaqsho ja sa",			TRUE},
    {'i',	"	mîeq heaqshuo ja",				TRUE},
    {'I',	"	sî ja sa shı heaqmu",			TRUE},
    {'q',	"	pîe ja sa majınao",				TRUE},
    {'r',	"	nôaq ja sa peq",				TRUE},
    {'e',	"	chûq ja sa haq",				TRUE},
    {'w',	"	jîaı ja sa hıaochuo",			TRUE},
    {'W',	"	gêısho ja sa fuq",				TRUE},
    {'T',	"	gêıshaı ja sa fuq",			TRUE},
    {'P',	"	gêısho ja sa cheıbıu",				TRUE},
    {'R',	"	gêıshaı ja sa cheıbıu",				TRUE},
    {'d',	"	hêaqshaı ja sa",				TRUE},
    {'c',	"	chûadoa ja sa sa",				TRUE},
    {'a',	"	nîqguo tao ja híqsoq",			TRUE},
    {')',	"	nâı jıaı ja hı",			TRUE},
    {']',	"	nâı geı ja hı fuq",			TRUE},
    {'=',	"	nâı geı ja hı cheıbıu",			TRUE},
    {'@',	"	mîeq ja puy raq suq",			TRUE},
    {'D',	"	môaqtao ja baq se duasho",		TRUE},
    {'o',	"	gâı ra beotua ja baq beodaı",			TRUE},
    {CTRL('R'),	"	nîqguo fuaqkaı jí tuq",				TRUE},
    {CTRL('P'),	"	nîqguo sî ja híqsoq kuqse",			TRUE},
    {ESCAPE,	"	bôta ja sa",			TRUE},
    {'S',	"	dâokaı ja jíaq",				TRUE},
    {'Q',	"	shâı luaq ja",					TRUE},
    {'!',	"	rîufa ja shély",				TRUE},
    {'F',	"<feo>	sôı chòe mûaqsho sa",		TRUE},
    {'v',	"	bâshoq ní hı",			TRUE},
    {0,		NULL }
};
